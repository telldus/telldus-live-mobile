	...
	:AbstractPush()
{
	...
	JNINativeMethod methods[] {{"callNativeSendRegistrationToServer", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", reinterpret_cast<void *>(Push::fromJavaSendRegistrationToServer)}};
...
void Push::fromJavaSendRegistrationToServer(JNIEnv *env, jobject thiz, jstring token, jstring name, jstring manufacturer, jstring model, jstring os_version) {
	Q_UNUSED(thiz);
	...
	Push::instance()->registerToken(QString(nativeToken), QString(nativeName), QString(nativeManufacturer), QString(nativeModel), QString(nativeOsVersion));
}
